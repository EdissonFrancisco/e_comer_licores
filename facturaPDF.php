...
$productosFactura = new Orden("", "", $_SESSION["id"], "", "", "", $numOrden, "");
...
for($i=0;$i<count($header);$i++)
    ...
    foreach($proFac as $producActual)
    {
        ...
        $pdf->Cell($w[0],6,$j++,1);
        $pdf->Cell($w[1],6,$producActual -> getIdProducto() -> getIdClaseLicor() -> getNombre() . " " . $producActual -> getIdProducto() -> getIdMarca() -> getNombre() ,1);
