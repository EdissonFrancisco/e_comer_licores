<?php
    ...
    $clientes = new Administrador($idPerfil);
    $clientes -> consultaTodo();
        
    if (isset($_POST["editar"])) {
        $clientes = new Administrador($idPerfil,  $_POST["nombre"], $_POST["apellido"], $_POST["cedula"], $_POST["direccion"], $_POST["correo"], "");
        $clientes -> actualizar();
        header("Location: index.php?pid=" . base64_encode("presentacion/admin/editarPerfil.php"));
    }
?>
			...
			<div class="col-9">
				<div class="card">
					...
					<div class="card-body">
    					...
    					<?php } ?>				
    					<form method="post" action="index.php?pid=<?php echo base64_encode("presentacion/admin/editarPerfil.php")?>&idPerfil=<?php echo $idPerfil ?>">
							<div class="mb-3">
